...
public class QuanLyKhachHang extends javax.swing.JPanel {
    ...
    private void btnthemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnthemActionPerformed
        ...
        if (!sdt.matches("^0\\d{9}$")) {
            JOptionPane.showMessageDialog(this, "Số điện thoại không hợp lệ! Phải bắt đầu bằng số '0' và đủ 10 chữ số.");
            return;
        }
    ...
    private void btnsuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsuaActionPerformed
        ...
        if (index == -1) {
            ...
            for (KhachHang kh : arr) {
                if (kh.getMaKhachHang() == maKH && kh != arr.get(index)) {
                    JOptionPane.showMessageDialog(this, "Mã Khách Hàng Đã Trùng!");
                }
            }
            String sdt = txtsdt.getText();
            if (!sdt.matches("^0\\d{9}$")) { // Regex kiểm tra số điện thoại bắt đầu bằng '0' và có đúng 10 chữ số
                JOptionPane.showMessageDialog(this, "Số điện thoại không hợp lệ! Phải bắt đầu bằng số '0' và đủ 10 chữ số.");
                return;
            }
